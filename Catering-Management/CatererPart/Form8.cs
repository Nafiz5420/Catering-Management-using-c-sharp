...
namespace CatererPart
{
    public partial class Form8 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into tangopack values(@ic,@item,@price,@pic)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "update tangopack set itemCount=@ic,itemName=@item,price=@price,pic=@pic where itemCount=@ic ";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@ic", textBox3.Text);
            cmd.Parameters.AddWithValue("@item", textBox1.Text);
            cmd.Parameters.AddWithValue("@price", textBox2.Text);
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from tangopack where itemCount=@ic ";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@ic", textBox3.Text);
